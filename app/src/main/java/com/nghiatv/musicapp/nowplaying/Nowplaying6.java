...
import com.nghiatv.musicapp.widgets.CircleImageView;

import net.steamcrafted.materialiconlib.MaterialDrawableBuilder;

public class Nowplaying6 extends BaseNowplayingFragment {
    private static final String TAG = "Nowplaying6";
    TextView nextSong;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(
                R.layout.fragment_music6, container, false);
    ...
    public void onMetaChanged() {
        ...
        if (getActivity() != null) {
            ...
            nextArt.setImageURI(MusicUtils.getAlbumArtUri(next.albumId));
        }
    }
}
