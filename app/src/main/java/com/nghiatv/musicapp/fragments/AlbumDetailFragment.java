...
import com.nghiatv.musicapp.adapters.AlbumSongsAdapter;
import com.nghiatv.musicapp.dataloaders.AlbumLoader;
import com.nghiatv.musicapp.dataloaders.AlbumSongLoader;
import com.nghiatv.musicapp.dialogs.AddPlaylistDialog;
import com.nghiatv.musicapp.listeners.SimplelTransitionListener;
import com.nghiatv.musicapp.models.Album;
...
import com.nghiatv.musicapp.utils.FabAnimationUtils;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.popup_song_addto_queue:
                MusicPlayer.addToQueue(context, mAdapter.getSongIds(), -1, MusicUtils.IdType.NA);
                break;
