...
public class Constants {
    ...
    public static final String NAVIGATE_VIDEO = "navigate_video";
    ...
    public static final String MUSIC3 = "music3";
    public static final String MUSIC4 = "music4";
    public static final String MUSIC5 = "music5";
    public static final String MUSIC6 = "music6";
