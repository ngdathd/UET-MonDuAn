...
public class SubStyleSelectorFragment extends Fragment {
    private static final String TAG = "SubStyleSelectorFragment";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            ...
            case 3:
                ...
                break;
            case 4:
                styleImage.setImageResource(R.drawable.music_5_nowplaying_x);
                break;
            case 5:
                styleImage.setImageResource(R.drawable.music_6_nowplaying_x);
                break;
        }
    ...
    private String getStyleForPageNumber() {
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                return Constants.MUSIC1;
            case 1:
                return Constants.MUSIC2;
            case 2:
                return Constants.MUSIC3;
            case 3:
                return Constants.MUSIC4;
            case 4:
                return Constants.MUSIC5;
            case 5:
                return Constants.MUSIC6;
            default:
                return Constants.MUSIC3;
        }
    }
