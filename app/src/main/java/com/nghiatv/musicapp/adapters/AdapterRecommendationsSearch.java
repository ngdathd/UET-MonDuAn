...
import com.nghiatv.musicapp.asynctasks.LastFMManager;
import com.nghiatv.musicapp.webservices.RecyclerClickListener;
...
public class AdapterRecommendationsSearch extends RecyclerView.Adapter<HolderRecommendationsSearch> {
    private static String TAG = "AdapterRecommendationsSearch";
    ...
    public void onBindViewHolder(HolderRecommendationsSearch holder, int position) {
        ImageLoader.getInstance().displayImage(image_artist_list.get(position), holder.image,
