...
import com.nghiatv.musicapp.widgets.BubbleTextGetter;
import com.nghiatv.musicapp.widgets.MusicVisualizer;
...
public class SongsListAdapter extends BaseSongAdapter<SongsListAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(ItemHolder itemHolder, int i) {
        ...
        ImageLoader.getInstance().displayImage(MusicUtils.getAlbumArtUri(localItem.albumId).toString(),
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId()) {
                            case R.id.popup_song_remove_playlist:
                                MusicUtils.removeFromPlaylist(mContext, arraylist.get(position).id, playlistId);
                            ...
                            case R.id.popup_song_share:
                               MusicUtils.shareTrack(mContext, arraylist.get(position).id);
                                break;
                            case R.id.popup_song_delete:
                                long[] deleteIds = {arraylist.get(position).id};
                                MusicUtils.showDeleteDialog(mContext,arraylist.get(position).title, deleteIds, SongsListAdapter.this, position);
                                break;
                        }
                        return false;
                    }
