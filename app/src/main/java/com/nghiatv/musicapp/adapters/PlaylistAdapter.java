...
import com.nghiatv.musicapp.dataloaders.LastAddedLoader;
import com.nghiatv.musicapp.dataloaders.PlaylistSongLoader;
import com.nghiatv.musicapp.dataloaders.SongLoader;
import com.nghiatv.musicapp.dataloaders.TopTracksLoader;
import com.nghiatv.musicapp.models.Playlist;
...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        itemHolder.artist.setText(" " + String.valueOf(songCountInt) + " " + mContext.getString(R.string.songs) + " - " + MusicUtils.makeShortTimeString(mContext,totalRuntime));
