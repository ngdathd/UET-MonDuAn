...
import com.nghiatv.musicapp.helpers.MediaButtonIntentReceiver;
import com.nghiatv.musicapp.helpers.MusicPlaybackTrack;
import com.nghiatv.musicapp.lastfmapi.LastFmClient;
import com.nghiatv.musicapp.lastfmapi.models.LastfmUserSession;
import com.nghiatv.musicapp.lastfmapi.models.ScrobbleQuery;
import com.nghiatv.musicapp.permissions.Permission;
import com.nghiatv.musicapp.provider.MusicPlaybackState;
import com.nghiatv.musicapp.provider.RecentStore;
import com.nghiatv.musicapp.provider.SongPlayCount;
...
import com.nghiatv.musicapp.utils.MusicUtils.IdType;
...
public class MusicService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.nghiatv.musicapp.playstatechanged";
    public static final String POSITION_CHANGED = "com.nghiatv.musicapp.positionchanged";
    public static final String META_CHANGED = "com.nghiatv.musicapp.metachanged";
    public static final String QUEUE_CHANGED = "com.nghiatv.musicapp.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.nghiatv.musicapp.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.nghiatv.musicapp.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.nghiatv.musicapp.shufflemodechanged";
    public static final String TRACK_ERROR = "com.nghiatv.musicapp.trackerror";
    public static final String APP_PACKAGE_NAME = "com.nghiatv.musicapp";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.nghiatv.musicapp.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.nghiatv.musicapp.togglepause";
    public static final String PAUSE_ACTION = "com.nghiatv.musicapp.pause";
    public static final String STOP_ACTION = "com.nghiatv.musicapp.stop";
    public static final String PREVIOUS_ACTION = "com.nghiatv.musicapp.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.nghiatv.musicapp.previous.force";
    public static final String NEXT_ACTION = "fcom.nghiatv.musicapp.next";
    public static final String REPEAT_ACTION = "com.nghiatv.musicapp.repeat";
    public static final String SHUFFLE_ACTION = "com.nghiatv.musicapp.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.nghiatv.musicapp.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.nghiatv.musicapp.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.nghiatv.musicapp.shutdown";
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(MusicUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
            ...
            if (c != null && c.getCount() != 0) {
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(MusicUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))))
